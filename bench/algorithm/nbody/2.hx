...
class Extensions {
	static public inline function product(a:Vec3, b:Vec3):Float {
		return a.x * b.x + a.y * b.y + a.z * b.z;
	}

	static public inline function minus0(a:Vec3, b:Vec3):Void {
		a.x -= b.x;
		a.y -= b.y;
		a.z -= b.z;
	}

	static public inline function minus(a:Vec3, b:Vec3):Vec3 {
		return {
			x: a.x - b.x,
			y: a.y - b.y,
			z: a.z - b.z
	...
	static public inline function add0(a:Vec3, b:Vec3):Void {
		a.x += b.x;
		a.y += b.y;
		a.z += b.z;
	}

	static public inline function add(a:Vec3, b:Vec3):Vec3 {
		return {
			x: a.x + b.x,
			y: a.y + b.y,
			z: a.z + b.z
	...
	static public inline function add2(a:Vec3, b:Float):Vec3 {
		return {
			x: a.x + b,
			y: a.y + b,
			z: a.z + b
	...
	static public inline function mul2(a:Vec3, b:Float):Vec3 {
		return {
			x: a.x * b,
			y: a.y * b,
			z: a.z * b
